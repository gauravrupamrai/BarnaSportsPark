        ...
        <div className="relative z-10 gap-5 items-center lg:flex">
          <div className="flex-1 max-w-lg py-5 sm:mx-auto sm:text-center lg:max-w-max lg:text-left">
            ...
            <div className="mt-5">
              <Link
                to="/register"
                className="px-4 py-2 text-indigo-600 font-medium bg-indigo-50 rounded-full inline-flex items-center mb-3"
              >
                Become a Member
                <svg
              ...
              <Link
                to="/register"
                className="invert px-4 py-2 text-indigo-600 font-medium bg-indigo-50 rounded-full inline-flex items-center"
              >
